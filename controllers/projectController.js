  ...
  try {
    ...
    if (removedImages.length) {
      for (const url of removedImages) {
        ...
        await gallery
          .deleteOne({ project: existingProject._id, image: url })
          .session(session);
      }
    }
    ...
    const updatedData = {
      ...
      bedrooms: req.body.bedrooms || existingProject.bedrooms,
      bathrooms: req.body.bathrooms || existingProject.bathrooms,
      area: req.body.area || existingProject.area,
      features: {
      ...
      image: finalImages,
      mainProject: req.body.mainProject || existingProject.mainProject,
    };
